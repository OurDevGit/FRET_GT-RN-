...
class BleClient
{
	public interface Delegate
	{
		...
		class Adapter implements Delegate
		{
			...
			@Override
			public void bleAvailableServicesForDevice(
				final BluetoothGatt gatt,
				final BluetoothDevice device,
				final List<BluetoothGattService> services)
			{
			...
			@Override
			public void bleAvailableCharacteristicsForService(
				final BluetoothGatt gatt,
				final BluetoothDevice device,
				final BluetoothGattService service,
				final List<BluetoothGattCharacteristic> characteristics)
			...
			@Override
			public void bleSuccessfulWrite(
				final BluetoothGatt gatt,
				final BluetoothDevice device,
				final BluetoothGattService service,
				final BluetoothGattCharacteristic characteristic,
			...
			@Override
			public void bleNewRssiAvailable(
				final BluetoothGatt gatt,
				final BluetoothDevice device,
				final int rssi)
			{
	...
	private final BluetoothGattCallback mBleCallback = new BluetoothGattCallback()
	{
		...
		public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status)
		{
			...
			String characteristicName = BleNamesResolver.resolveCharacteristicName(characteristic.getUuid().toString().toLowerCase(Locale.getDefault()));
			...
			{
				mDelegate.bleFailedWrite(gatt, gatt.getDevice(), characteristic.getService(), characteristic, description + " STATUS = " + status);
			}
		}
	};
}
