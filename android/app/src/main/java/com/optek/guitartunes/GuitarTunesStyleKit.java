...
/**
 * Created by Stephen Haase & Rick Terrill on Nov 1, 2017.
...
public class GuitarTunesStyleKit {
    ...
    public static void drawBtnNext(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean isPressed, float redValue, float greenValue, float blueValue) {
        ...
        bezierRect.set(3.11f, 1.65f, 42.8f, 41.35f);
        Path bezierPath = CacheForBtnNext.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(42.47f, 20.84f);
        bezierPath.lineTo(19.32f, 3.47f);
        bezierPath.cubicTo(19.07f, 3.29f, 18.74f, 3.26f, 18.45f, 3.4f);
        bezierPath.cubicTo(18.17f, 3.54f, 18f, 3.82f, 18f, 4.13f);
        bezierPath.lineTo(18f, 13.87f);
        bezierPath.lineTo(4.49f, 1.86f);
        bezierPath.cubicTo(4.25f, 1.65f, 3.9f, 1.59f, 3.6f, 1.73f);
        bezierPath.cubicTo(3.3f, 1.86f, 3.11f, 2.16f, 3.11f, 2.48f);
        bezierPath.lineTo(3.11f, 40.52f);
        bezierPath.cubicTo(3.11f, 40.85f, 3.3f, 41.14f, 3.6f, 41.27f);
        bezierPath.cubicTo(3.71f, 41.32f, 3.82f, 41.35f, 3.94f, 41.35f);
        bezierPath.cubicTo(4.14f, 41.35f, 4.34f, 41.27f, 4.49f, 41.14f);
        bezierPath.lineTo(18f, 29.13f);
        bezierPath.lineTo(18f, 38.86f);
        bezierPath.cubicTo(18f, 39.18f, 18.17f, 39.47f, 18.45f, 39.61f);
        bezierPath.cubicTo(18.74f, 39.74f, 19.07f, 39.71f, 19.32f, 39.53f);
        bezierPath.lineTo(42.47f, 22.16f);
        bezierPath.cubicTo(42.68f, 22.01f, 42.8f, 21.76f, 42.8f, 21.5f);
        bezierPath.cubicTo(42.8f, 21.24f, 42.68f, 21f, 42.47f, 20.84f);
        bezierPath.close();
