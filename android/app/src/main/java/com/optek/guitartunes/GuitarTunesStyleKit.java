...
/**
 * Created by Stephen Haase & Rick Terrill on Mar 5, 2018.
 * Copyright © 2018 Big Swing. All rights reserved.
 *
...
public class GuitarTunesStyleKit {
    ...
    public static void drawBtnChordsAndScales(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean isChordsAndScales) {
        ...
        // Group 2
        {
            ...
            rectangleRect.set(8.95f, 7.95f, 35.95f, 34.95f);
            ...
            bezier2Rect.set(14.7f, 8.4f, 14.7f, 34.79f);
            Path bezier2Path = CacheForBtnChordsAndScales.bezier2Path;
            bezier2Path.reset();
            bezier2Path.moveTo(14.7f, 8.4f);
            bezier2Path.lineTo(14.7f, 34.79f);
            ...
            bezierRect.set(20.1f, 8.4f, 20.1f, 34.79f);
            Path bezierPath = CacheForBtnChordsAndScales.bezierPath;
            bezierPath.reset();
            bezierPath.moveTo(20.1f, 8.4f);
            bezierPath.lineTo(20.1f, 34.79f);
            ...
            bezier3Rect.set(25.5f, 8.4f, 25.5f, 34.79f);
            Path bezier3Path = CacheForBtnChordsAndScales.bezier3Path;
            bezier3Path.reset();
            bezier3Path.moveTo(25.5f, 8.4f);
            bezier3Path.lineTo(25.5f, 34.79f);
            ...
            bezier4Rect.set(30.9f, 8.4f, 30.9f, 34.79f);
            Path bezier4Path = CacheForBtnChordsAndScales.bezier4Path;
            bezier4Path.reset();
            bezier4Path.moveTo(30.9f, 8.4f);
            bezier4Path.lineTo(30.9f, 34.79f);
            ...
            bezier5Rect.set(9.36f, 12.76f, 35.62f, 12.76f);
            Path bezier5Path = CacheForBtnChordsAndScales.bezier5Path;
            bezier5Path.reset();
            bezier5Path.moveTo(9.36f, 12.76f);
            bezier5Path.lineTo(35.62f, 12.76f);
            ...
            bezier6Rect.set(9.36f, 18.16f, 35.62f, 18.16f);
            Path bezier6Path = CacheForBtnChordsAndScales.bezier6Path;
            bezier6Path.reset();
            bezier6Path.moveTo(9.36f, 18.16f);
            bezier6Path.lineTo(35.62f, 18.16f);
            ...
            bezier7Rect.set(9.36f, 24.46f, 35.62f, 24.46f);
            Path bezier7Path = CacheForBtnChordsAndScales.bezier7Path;
            bezier7Path.reset();
            bezier7Path.moveTo(9.36f, 24.46f);
            bezier7Path.lineTo(35.62f, 24.46f);
            ...
            bezier8Rect.set(9.36f, 29.86f, 35.62f, 29.86f);
            Path bezier8Path = CacheForBtnChordsAndScales.bezier8Path;
            bezier8Path.reset();
            bezier8Path.moveTo(9.36f, 29.86f);
            bezier8Path.lineTo(35.62f, 29.86f);
            ...
            ovalRect.set(13.06f, 19.5f, 16.56f, 23f);
            ...
            oval2Rect.set(18.5f, 13.38f, 22f, 16.88f);
            ...
            oval3Rect.set(29.06f, 8.44f, 32.56f, 11.94f);
    ...
    private static class CacheForBtnMailContest {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 44f, 44f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawBtnMailContest(Canvas canvas) {
        GuitarTunesStyleKit.drawBtnMailContest(canvas, new RectF(0f, 0f, 44f, 44f), ResizingBehavior.AspectFit);
    }
    
    public static void drawBtnMailContest(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        // General Declarations
        Paint paint = CacheForBtnMailContest.paint;
        ...
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForBtnMailContest.resizedFrame;
        GuitarTunesStyleKit.resizingBehaviorApply(resizing, CacheForBtnMailContest.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 44f, resizedFrame.height() / 44f);
        ...
        {
            // Bezier
            RectF bezierRect = CacheForBtnMailContest.bezierRect;
            bezierRect.set(18.89f, 14.45f, 25.15f, 20.19f);
            Path bezierPath = CacheForBtnMailContest.bezierPath;
            bezierPath.reset();
            bezierPath.moveTo(22.02f, 14.45f);
            bezierPath.lineTo(23.06f, 16.54f);
            bezierPath.lineTo(25.15f, 16.54f);
            bezierPath.lineTo(23.46f, 17.83f);
            bezierPath.lineTo(24.11f, 20.19f);
            bezierPath.lineTo(22.02f, 18.62f);
            bezierPath.lineTo(19.93f, 20.19f);
            bezierPath.lineTo(20.76f, 17.83f);
            bezierPath.lineTo(18.89f, 16.54f);
            bezierPath.lineTo(20.98f, 16.54f);
            bezierPath.lineTo(22.02f, 14.45f);
            bezierPath.lineTo(22.02f, 14.45f);
            bezierPath.close();
            ...
            // Bezier 2
            RectF bezier2Rect = CacheForBtnMailContest.bezier2Rect;
            bezier2Rect.set(10.05f, 13.41f, 14.88f, 21.75f);
            Path bezier2Path = CacheForBtnMailContest.bezier2Path;
            bezier2Path.reset();
            bezier2Path.moveTo(14.88f, 21.75f);
            bezier2Path.cubicTo(9.66f, 21.75f, 10.06f, 14.85f, 10.06f, 13.41f);
            bezier2Path.lineTo(12.7f, 13.41f);
            ...
            // Bezier 3
            RectF bezier3Rect = CacheForBtnMailContest.bezier3Rect;
            bezier3Rect.set(29.2f, 13.41f, 34.06f, 21.75f);
            Path bezier3Path = CacheForBtnMailContest.bezier3Path;
            bezier3Path.reset();
            bezier3Path.moveTo(29.2f, 21.75f);
            bezier3Path.cubicTo(34.42f, 21.75f, 34.05f, 14.85f, 34.05f, 13.41f);
            bezier3Path.lineTo(31.38f, 13.41f);
            ...
            // Bezier 9
            RectF bezier9Rect = CacheForBtnMailContest.bezier9Rect;
            bezier9Rect.set(12.67f, 11.32f, 31.45f, 35.32f);
            Path bezier9Path = CacheForBtnMailContest.bezier9Path;
            bezier9Path.reset();
            bezier9Path.moveTo(31.45f, 11.32f);
            bezier9Path.lineTo(12.67f, 11.32f);
            bezier9Path.cubicTo(12.67f, 27.42f, 20.98f, 22.85f, 20.98f, 28.54f);
            bezier9Path.cubicTo(20.91f, 32.19f, 19.2f, 33.23f, 16.32f, 33.23f);
            bezier9Path.lineTo(16.32f, 35.32f);
            bezier9Path.lineTo(27.8f, 35.32f);
            bezier9Path.lineTo(27.8f, 33.23f);
            bezier9Path.cubicTo(24.91f, 33.23f, 23.06f, 32.19f, 23.06f, 28.54f);
            bezier9Path.cubicTo(23.06f, 22.85f, 31.45f, 27.36f, 31.45f, 11.32f);
            bezier9Path.lineTo(31.45f, 11.32f);
            bezier9Path.close();
    ...
    public static void drawBtnDetails(Canvas canvas, boolean isPressed) {
        GuitarTunesStyleKit.drawBtnDetails(canvas, new RectF(0f, 0f, 44f, 44f), ResizingBehavior.AspectFit, isPressed);
    }
    
    public static void drawBtnDetails(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean isPressed) {
        // General Declarations
        ...
        // Group
        {
            ...
            textRect.set(21.6f, 16.37f, 22.97f, 24.94f);
            Path textPath = CacheForBtnDetails.textPath;
            textPath.reset();
            textPath.moveTo(21.6f, 16.37f);
            textPath.lineTo(22.97f, 16.37f);
            textPath.lineTo(22.97f, 17.67f);
            textPath.lineTo(21.6f, 17.67f);
            textPath.lineTo(21.6f, 16.37f);
            textPath.close();
            textPath.moveTo(21.6f, 18.74f);
            textPath.lineTo(22.97f, 18.74f);
            textPath.lineTo(22.97f, 24.94f);
            textPath.lineTo(21.6f, 24.94f);
            textPath.lineTo(21.6f, 18.74f);
            textPath.close();
    ...
    public static void drawBtnTuner(Canvas canvas) {
        GuitarTunesStyleKit.drawBtnTuner(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit);
    }
    
    public static void drawBtnTuner(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        // General Declarations
        Paint paint = CacheForBtnTuner.paint;
        
        // Local Colors
        int tunerColor = Color.argb(255, 227, 54, 54);
