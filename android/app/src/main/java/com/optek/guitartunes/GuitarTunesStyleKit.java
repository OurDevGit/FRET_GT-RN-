...
/**
 * Created by Stephen Haase & Rick Terrill on 8/30/17.
...
public class GuitarTunesStyleKit {
    ...
    public static void drawBtnDelete(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean isPressed, float redValue, float greenValue, float blueValue) {
        ...
        bezierRect.set(9.58f, 21f, 35.3f, 21f);
        Path bezierPath = CacheForBtnDelete.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(9.58f, 21f);
        bezierPath.cubicTo(9.58f, 21f, 35.3f, 21f, 35.3f, 21f);
