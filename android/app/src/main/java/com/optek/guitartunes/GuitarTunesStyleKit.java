...
/**
 * Created by Stephen Haase & Rick Terrill on 10/3/17.
...
public class GuitarTunesStyleKit {
    ...
    public static void drawBtnDelete(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean isPressed, float redValue, float greenValue, float blueValue) {
        ...
        oval4Rect.set(4f, 3.88f, 40f, 39.88f);
    ...
    public static void drawBtnInfo(Canvas canvas) {
        GuitarTunesStyleKit.drawBtnInfo(canvas, new RectF(0f, 0f, 44f, 44f), ResizingBehavior.AspectFit);
    }
    
    public static void drawBtnInfo(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        // General Declarations
