...
/**
 * Created by Stephen Haase & Rick Terrill on 8/20/17.
...
public class GuitarTunesStyleKit {
    ...
    public static void drawBtnLoopRight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        {
            canvas.save();
            canvas.translate(31.74f, 7.49f);
            currentTransformation.peek().postTranslate(31.74f, 7.49f);
            
            // Stroke- 3
            RectF stroke3Rect = CacheForBtnLoopRight.stroke3Rect;
            stroke3Rect.set(-0.41f, 0.26f, -0.36f, 30.26f);
            Path stroke3Path = CacheForBtnLoopRight.stroke3Path;
            stroke3Path.reset();
            stroke3Path.moveTo(-0.41f, 0.26f);
            stroke3Path.lineTo(-0.36f, 30.26f);
            ...
            triangleRect.set(-20.2f, 0.94f, -1.48f, 18.67f);
            Path trianglePath = CacheForBtnLoopRight.trianglePath;
            trianglePath.reset();
            trianglePath.moveTo(-20.2f, 9.81f);
            trianglePath.lineTo(-1.48f, 18.67f);
            trianglePath.lineTo(-1.48f, 0.94f);
            trianglePath.lineTo(-20.2f, 9.81f);
            trianglePath.close();
    ...
    public static void drawBtnLoopLeft(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        {
            canvas.save();
            canvas.translate(13.83f, 6.41f);
            currentTransformation.peek().postTranslate(13.83f, 6.41f);
            
            // Stroke-
            RectF strokeRect = CacheForBtnLoopLeft.strokeRect;
            strokeRect.set(0.2f, 0.5f, 0.2f, 30.5f);
            Path strokePath = CacheForBtnLoopLeft.strokePath;
            strokePath.reset();
            strokePath.moveTo(0.2f, 0.5f);
            strokePath.lineTo(0.2f, 30.5f);
            ...
            triangle1Rect.set(0.97f, 0.5f, 22.7f, 19.59f);
            Path triangle1Path = CacheForBtnLoopLeft.triangle1Path;
            triangle1Path.reset();
            triangle1Path.moveTo(22.7f, 10.05f);
            triangle1Path.lineTo(0.97f, 19.59f);
            triangle1Path.lineTo(0.97f, 0.5f);
            triangle1Path.lineTo(22.7f, 10.05f);
            triangle1Path.close();
