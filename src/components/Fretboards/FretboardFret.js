  ...
  <View style={{ ...style, flex: 1 }}>
    ...
    <View style={{ flex: 1}}>
      <View style={{ width: "100%", height: "100%", paddingVertical: 3, justifyContent: "space-between", alignItems: "center", marginLeft: -3 }} >
        <FretboardNote key={0} track={track} fret={fret} string={isBass ? 2 : 0} notation={notation(fret, 0)}/>
        <FretboardNote key={1} track={track} fret={fret} string={isBass ? 3 : 1} notation={notation(fret, 1)}/>
        <FretboardNote key={2} track={track} fret={fret} string={isBass ? 4 : 2} notation={notation(fret, 2)}/>
        <FretboardNote key={3} track={track} fret={fret} string={isBass ? 5 : 3} notation={notation(fret, 3)}/>
